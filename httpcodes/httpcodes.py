httpcodes_dict = {100: {'code': 100,
                  ...
                  101: {'code': 101,
                        'category': 'Information responses',
                        'short_description': '101 Switching Protocols',
                  ...
                  102: {'code': 102,
                        'category': 'Information responses',
                        'short_description': '102 Processing (WebDAV)',
                  ...
                  103: {'code': 103,
                        'category': 'Information responses',
                        'short_description': '103 Early Hints Experimental',
                  ...
                  202: {'code': 202,
                        'category': 'Successful responses',
                        'short_description': '202 Accepted',
                  ...
                  203: {'code': 203,
                        'category': 'Successful responses',
                        'short_description': '203 Non-Authoritative Information',
                  ...
                  226: {'code': 226,
                        'category': 'Successful responses',
                        'short_description': '226 IM Used (HTTP Delta encoding)',
                        'description': 'The server has fulfilled a GET request for the resource, and the response is a representation of the result of one or more instance-manipulations applied to the current instance.'},
                  300: {'code': 300,
                        'category': 'Redirection messages',
                        'short_description': '300 Multiple Choices',
                  ...
                  303: {'code': 303,
                        'category': 'Redirection messages',
                        'short_description': '303 See Other',
                  ...
                  304: {'code': 304,
                        'category': 'Redirection messages',
                        'short_description': '304 Not Modified',
                  ...
                  305: {'code': 305,
                        'category': 'Redirection messages',
                        'short_description': '305 Use Proxy Deprecated',
                  ...
                  402: {'code': 402,
                        'category': 'Client error responses',
                        'short_description': '402 Payment Required Experimental',
                  ...
                  405: {'code': 405,
                        'category': 'Client error responses',
                        'short_description': '405 Method Not Allowed',
                  ...
                  406: {'code': 406,
                        'category': 'Client error responses',
                        'short_description': '406 Not Acceptable',
                  ...
                  417: {'code': 417,
                        'category': 'Client error responses',
                        'short_description': '417 Expectation Failed',
                  ...
                  418: {'code': 418,
                        'category': 'Client error responses',
                        'short_description': "418 I'm a teapot",
                        'description': 'The server refuses the attempt to brew coffee with a teapot.'},
                  421: {'code': 421,
                        'category': 'Client error responses',
                        'short_description': '421 Misdirected Request',
                  ...
                  422: {'code': 422,
                        'category': 'Client error responses',
                        'short_description': '422 Unprocessable Content (WebDAV)',
                        'description': 'The request was well-formed but was unable to be followed due to semantic errors.'},
                  423: {'code': 423,
                        'category': 'Client error responses',
                        'short_description': '423 Locked (WebDAV)',
                        'description': 'The resource that is being accessed is locked.'},
                  424: {'code': 424,
                        'category': 'Client error responses',
                        'short_description': '424 Failed Dependency (WebDAV)',
                        'description': 'The request failed due to failure of a previous request.'},
                  425: {'code': 425,
                        'category': 'Client error responses',
                        'short_description': '425 Too Early Experimental',
                        'description': 'Indicates that the server is unwilling to risk processing a request that might be replayed.'},
                  426: {'code': 426,
                        'category': 'Client error responses',
                        'short_description': '426 Upgrade Required',
                  ...
                  428: {'code': 428,
                        'category': 'Client error responses',
                        'short_description': '428 Precondition Required',
                  ...
                  429: {'code': 429,
                        'category': 'Client error responses',
                        'short_description': '429 Too Many Requests',
                        'description': 'The user has sent too many requests in a given amount of time ("rate limiting").'},
                  431: {'code': 431,
                        'category': 'Client error responses',
                        'short_description': '431 Request Header Fields Too Large',
                  ...
                  451: {'code': 451,
                        'category': 'Client error responses',
                        'short_description': '451 Unavailable For Legal Reasons',
                  ...
                  501: {'code': 501,
                        'category': 'Server error responses',
                        'short_description': '501 Not Implemented',
                  ...
                  502: {'code': 502,
                        'category': 'Server error responses',
                        'short_description': '502 Bad Gateway',
                  ...
                  503: {'code': 503,
                        'category': 'Server error responses',
                        'short_description': '503 Service Unavailable',
                        'description': 'The server is not ready to handle the request.  Common causes are a server that is down for maintenance or that is overloaded.  Note that together with this response, a user-friendly page explaining the problem should be sent.  This response should be used for temporary conditions and the Retry-After HTTP header should, if possible, contain the estimated time before the recovery of the service.  The webmaster must also take care about the caching-related headers that are sent along with this response, as these temporary condition responses should usually not be cached.'},
                  504: {'code': 504,
                        'category': 'Server error responses',
                        'short_description': '504 Gateway Timeout',
                        'description': 'This error response is given when the server is acting as a gateway and cannot get a response in time.'},
                  505: {'code': 505,
                        'category': 'Server error responses',
                        'short_description': '505 HTTP Version Not Supported',
                        'description': 'The HTTP version used in the request is not supported by the server.'},
                  506: {'code': 506,
                        'category': 'Server error responses',
                        'short_description': '506 Variant Also Negotiates',
                        'description': 'The server has an internal configuration error: the chosen variant resource is configured to engage in transparent content negotiation itself, and is therefore not a proper end point in the negotiation process.'},
                  507: {'code': 507,
                        'category': 'Server error responses',
                        'short_description': '507 Insufficient Storage (WebDAV)',
                        'description': 'The method could not be performed on the resource because the server is unable to store the representation needed to successfully complete the request.'},
                  508: {'code': 508,
                        'category': 'Server error responses',
                        'short_description': '508 Loop Detected (WebDAV)',
                        'description': 'The server detected an infinite loop while processing the request.'},
                  510: {'code': 510,
                        'category': 'Server error responses',
                        'short_description': '510 Not Extended',
                        'description': 'Further extensions to the request are required for the server to fulfill it.'},
                  511: {'code': 511,
                        'category': 'Server error responses',
                        'short_description': '511 Network Authentication Required',
                        'description': 'Indicates that the client needs to authenticate to gain network access.'}}

def get_response_by_code(status_code):
    return httpcodes_dict[status_code]

def get_all_responses():
    return httpcodes_dict

def get_all_categories():
    return ['1xx informational response – the request was received, continuing process',
